...
<h2> Archived Modules </h2>
	...
	foreach($stmt as $row){
		...
		<tr>
			...
			<td style="padding:10px"><a href="index.php?page=module&did=<?php echo $row['module_id'];  ?>">Delete</a><br><a href="index.php?page=module&march=<?php echo $row['module_id'];  ?>&an=1">De-Archive</a>

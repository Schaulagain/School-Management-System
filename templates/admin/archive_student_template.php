...
<h2> Archived Students </h2>
	...
	foreach($stmt as $row){
		...
		<tr>
			...
			<td style="padding:10px"><a href="index.php?page=updateStudent&id=<?php echo $row['student_id'];  ?>">Update</a><br><a href="index.php?page=student&did=<?php echo $row['student_id'];  ?>">Delete</a><br><a href="index.php?page=student&acid=<?php echo $row['student_id'];  ?>&an=1">De-Archive</a</td>
		</tr>
		<?php } }
		?>
	</table>
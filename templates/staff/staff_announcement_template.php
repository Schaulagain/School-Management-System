					...
					<div class="article border-bottom">
						<div class="col-xs-12">
							...
							<div class="col-xs-10 col-md-10">
								<h4><?php echo $key['ano_title'];?><a href="index.php?page=staff_announcement&did=<?php echo $key['ano_id'];  ?>"> Delete</a><a href="index.php?page=staff_announcement&anoamd=<?php echo $key['ano_id'];  ?>&an=0;"> Archive</a></td>
								</h4>
